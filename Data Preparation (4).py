...
import pandas as pd
import mne
file = "C:\\Users\\lenovo\\Desktop\\SC4001E0-PSG.edf"
data = mne.io.read_raw_edf(file)
raw_data = data.get_data()
df = pd.DataFrame(raw_data.T)
df.columns =[' EEG Fpz-Cz', 'EEG Pz-Oz', 'EOG horizontal', 'Resp oro-nasal','EMG submental','EMG submental','Event marker']
df.head(10)
...
def main():
    ...
    parser.add_argument(default="C:\\Users\\lenovo\\Desktop\\SC4001E0-PSG.edf")
    parser.add_argument("C:\\Users\\lenovo\\Desktop\\Sleepnet.csv", type=str,)
